...
$query= "insert into product(name,category,description,short_des,old_price,price,image,desc_image) values('$name','$category','$description','$short_des','$old_price','$price','$image','$desc_img');";
